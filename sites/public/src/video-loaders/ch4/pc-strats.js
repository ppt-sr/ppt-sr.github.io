...
function fetchVideos() {
    fetch('/jsons/ch4/strats.json')
        .then(response => response.json())
        .then(data => {
            const videoContainer = document.getElementById('strats-container-ch4');
            ...
            const updateFilters = () => {
                ...
                if (document.getElementById('ur-cb').checked) selectedRoutes.push('Unrestricted');
